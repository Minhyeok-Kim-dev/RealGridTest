...
var dataProvider;
	...
	$(document).ready(function() {
	    ...
	    $("#btnChangeSortStyleInclusive").on("click", function(){
	        setSortStyle(RealGridJS.SortStyle.INCLUSIVE);
	    });   
	    
	    $("#btnChangeSortStyleReverse").on("click", function(){
	    	setSortStyle(RealGridJS.SortStyle.REVERSE);
	    });
	});
...
<body>
	...
	<button type="button" class="btn btn-primary btn-xs" id="btnChangeSortStyleInclusive">Inclusive</button>
	<button type="button" class="btn btn-primary btn-xs" id="btnChangeSortStyleReverse">Reverse</button>
